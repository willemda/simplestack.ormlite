...
namespace Northwind.Common.DataModel
{
	public class OrderBlob : IHasIntId, IHasId<int>
	{
		...
		public static OrderBlob Create(int orderId)
		{
			...
			orderBlob.Customer = NorthwindFactory.Customer("ALFKI", "Alfreds Futterkiste", "Maria Anders", "Sales Representative",
			                                               "Obere Str. 57", "Berlin", null, "12209", "Germany", "030-0074321",
			                                               "030-0076545", null);
			orderBlob.Employee = NorthwindFactory.Employee(1, "Davolio", "Nancy", "Sales Representative", "Ms.",
			                                               new DateTime?(NorthwindData.ToDateTime("12/08/1948")),
			                                               new DateTime?(NorthwindData.ToDateTime("05/01/1992")),
			                                               "507 - 20th Ave. E. Apt. 2A", "Seattle", "WA", "98122", "USA",
			                                               "(206) 555-9857", "5467", null,
			                                               "Education includes a BA in psychology from Colorado State University in 1970.  She also completed 'The Art of the Cold Call.'  Nancy is a member of Toastmasters International.",
			                                               new int?(2), "http://accweb/emmployees/davolio.bmp");
