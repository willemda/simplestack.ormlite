				...
				con.Insert(new TestType
					           {
						           Id = 1,
						           BoolCol = true,
						           DateCol = new DateTime(2012, 1, 1),
						           TextCol = "asdf",
						           EnumCol = TestEnum.Val0
					           });
				con.Insert(new TestType
					           {
						           Id = 2,
						           BoolCol = true,
						           DateCol = new DateTime(2012, 2, 1),
						           TextCol = "asdf123",
						           EnumCol = TestEnum.Val1
					           });
				con.Insert(new TestType
					           {
						           Id = 3,
						           BoolCol = false,
						           DateCol = new DateTime(2012, 3, 1),
						           TextCol = "qwer",
						           EnumCol = TestEnum.Val2
					           });
				con.Insert(new TestType
					           {
						           Id = 4,
						           BoolCol = false,
						           DateCol = new DateTime(2012, 4, 1),
						           TextCol = "qwer123",
