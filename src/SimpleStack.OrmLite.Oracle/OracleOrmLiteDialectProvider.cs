	...
	public class OracleOrmLiteDialectProvider : OrmLiteDialectProviderBase<OracleOrmLiteDialectProvider>
	{
		...
		public override string GetQuotedValue(object value, Type fieldType)
		{
			...
			if (fieldType == typeof (DateTime) || fieldType == typeof (DateTime?))
			{
				...
				return "TO_TIMESTAMP(" + base.GetQuotedValue(dateValue.ToString(iso8601Format), typeof (string)) + ", " +
		...
		public override IDbCommand CreateParameterizedInsertStatement(IDbConnection connection, object objWithProperties,
