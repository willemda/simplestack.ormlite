...
namespace SimpleStack.OrmLite
{
	public interface IOrmLiteDialectProvider
	{
		...
		IDbCommand CreateParameterizedInsertStatement(IDbConnection connection, object objWithProperties,
		                                              ICollection<string> insertFields = null);

		void ReParameterizeInsertStatement(IDbCommand command, object objWithProperties,
		                                   ICollection<string> insertFields = null);

		string ToUpdateRowStatement(object objWithProperties, ICollection<string> UpdateFields = null);

		IDbCommand CreateParameterizedUpdateStatement(IDbConnection connection, object objWithProperties,
